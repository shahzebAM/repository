...
<div className="css">
    ...
    <Card.Body style={{padding:10}}>
      ...
      {/* <Card.Text> */}
      <iframe width="200" height="150" src={val.src} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      {/* </Card.Text> */}
